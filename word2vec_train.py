...
tf.flags.DEFINE_integer("num_filters", 140, "Number of filters per filter size (default: 128)")
tf.flags.DEFINE_float("dropout_keep_prob", 0.77, "Dropout keep probability (default: 0.5)")
