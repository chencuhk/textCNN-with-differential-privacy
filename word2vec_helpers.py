...
def embedding_sentences(sentences, embedding_size = 300, window = 5, min_count = 5, file_to_load = None, file_to_save = None):
...
def generate_word2vec_files(input_file, output_model_file, output_vector_file, size = 300, window = 5, min_count = 5):
